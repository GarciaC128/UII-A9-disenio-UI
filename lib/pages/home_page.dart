...
import 'package:garcia/data/categories.dart';
import 'package:garcia/data/products.dart';
import 'package:garcia/pages/product_details_page.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: ActionChip(
          ...
          backgroundColor: const Color(0xffEEDEC9),
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    "Encuentra los mejores platillos",
                    style: theme.textTheme.headlineMedium
                        ?.copyWith(color: Color(0xffEEDEC9)),
                  ),
                ),
                SizedBox(
                  height: 106,
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Image.asset("assets/Lasagna.jpg"),
                            ),
                            Flexible(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
